...
seq_len=96
if [ ! -d "./log_05292020_40" ]; then
    mkdir ./log_05292020_40
fi

if [ ! -d "./log_05292020_40/ETTm1" ]; then
    mkdir ./log_05292020_40/ETTm1
fi
if [ ! -d "./log_05292020_40/ETTh1" ]; then
    mkdir ./log_05292020_40/ETTh1
fi
if [ ! -d "./log_05292020_40/ETTm2" ]; then
    mkdir ./log_05292020_40/ETTm2
fi

if [ ! -d "./log_05292020_40/ETTh2" ]; then
    mkdir ./log_05292020_40/ETTh2
fi
if [ ! -d "./log_05292020_40/electricity" ]; then
    mkdir ./log_05292020_40/electricity
fi

if [ ! -d "./log_05292020_40/Exchange" ]; then
    mkdir ./log_05292020_40/Exchange
fi

if [ ! -d "./log_05292020_40/Solar" ]; then
    mkdir ./log_05292020_40/Solar
fi

if [ ! -d "./log_05292020_40/weather" ]; then
    mkdir ./log_05292020_40/weather
fi

if [ ! -d "./log_05292020_40/Traffic" ]; then
    mkdir ./log_05292020_40/Traffic
fi

if [ ! -d "./log_05292020_40/PEMS03" ]; then
    mkdir ./log_05292020_40/PEMS03
fi

if [ ! -d "./log_05292020_40/PEMS04" ]; then
    mkdir ./log_05292020_40/PEMS04
fi

if [ ! -d "./log_05292020_40/PEMS07" ]; then
    mkdir ./log_05292020_40/PEMS07
fi
if [ ! -d "./log_05292020_40/PEMS08" ]; then
    mkdir ./log_05292020_40/PEMS08
fi
...
for pred_len in 96  192 336 720; do
 python -u  /mnt/nfs/data/home/1120231440/home/fuy/python/MICN_Experience/run.py \
  ...
  > log_05292020_40/ETTh1/'0'_$model_name'_'ETTh1'_'$seq_len'_'$pred_len'_'0.01.log 2>&1
done
...
for pred_len in 96  192 336 720; do
   python -u  /mnt/nfs/data/home/1120231440/home/fuy/python/MICN_Experience/run.py \
        ...
        --front_use_decomp $front_use_decomp \
        --use_x_mark_enc $use_x_mark_enc \
    > log_05292020_40/ETTh2/'0'_$model_name'_'ETTh2'_'$seq_len'_'$pred_len'_'0.01.log 2>&1
  done
...
# m1 d_model= d_ff = 128
  ...
  for pred_len in 96 192 336 720; do
   python -u  /mnt/nfs/data/home/1120231440/home/fuy/python/MICN_Experience/run.py \
        ...
        --front_use_decomp $front_use_decomp \
        --use_x_mark_enc $use_x_mark_enc \
    > log_05292020_40/ETTm1/'0'_$model_name'_'ETTm1'_'$seq_len'_'$pred_len'_'0.01.log 2>&1
  done
...
# m2 d_model= d_ff = 128
  for pred_len in 96 192 336 720; do
   python -u  /mnt/nfs/data/home/1120231440/home/fuy/python/MICN_Experience/run.py \
        ...
        --front_use_decomp $front_use_decomp \
        --use_x_mark_enc $use_x_mark_enc \
    > log_05292020_40/ETTm2/'0'_$model_name'_'ETTm2'_'$seq_len'_'$pred_len'_'0.01.log 2>&1
  done
...
# electricity d_model=d_ff=512
 ...
 for pred_len in 96 192 336 720 ; do
   python -u  /mnt/nfs/data/home/1120231440/home/fuy/python/MICN_Experience/run.py \
        ...
        --front_use_decomp $front_use_decomp \
        --use_x_mark_enc $use_x_mark_enc \
    > log_05292020_40/electricity/'0'_$model_name'_'electricity'_'$seq_len'_'$pred_len'_'0.01.log 2>&1
  done
...
for pred_len in 96 192 336 720; do
   python -u  /mnt/nfs/data/home/1120231440/home/fuy/python/MICN_Experience/run.py \
        ...
        --front_use_decomp $front_use_decomp \
        --use_x_mark_enc $use_x_mark_enc \
    > log_05292020_40/Traffic/'0'_$model_name'_'Traffic'_'$seq_len'_'$pred_len'_'0.01.log 2>&1
  done
...
# Exchange d_model=d_ff=128
  for pred_len in 96 192 336 720; do
   python -u  /mnt/nfs/data/home/1120231440/home/fuy/python/MICN_Experience/run.py \
        ...
        --front_use_decomp $front_use_decomp \
        --use_x_mark_enc $use_x_mark_enc \
    > log_05292020_40/Exchange/'0'_$model_name'_'Exchange'_'$seq_len'_'$pred_len'_'0.01.log 2>&1
  done
...
# weather d_ff=d_ff=512
  for pred_len in 96 192 336 720 ; do
   python -u  /mnt/nfs/data/home/1120231440/home/fuy/python/MICN_Experience/run.py \
        ...
        --front_use_decomp $front_use_decomp \
        --use_x_mark_enc $use_x_mark_enc \
    > log_05292020_40/weather/'0'_$model_name'_'weather'_'$seq_len'_'$pred_len'_'0.01.log 2>&1
  done
...
for pred_len in 96 192 336 720 ; do
   python -u  /mnt/nfs/data/home/1120231440/home/fuy/python/MICN_Experience/run.py \
        ...
        --front_use_decomp $front_use_decomp \
        --use_x_mark_enc $use_x_mark_enc \
    > log_05292020_40/Solar/'0'_$model_name'_'weather'_'$seq_len'_'$pred_len'_'0.01.log 2>&1
  done
...
for pred_len in 12 24 48 96 ; do
   python -u  /mnt/nfs/data/home/1120231440/home/fuy/python/MICN_Experience/run.py \
        ...
        --front_use_decomp $front_use_decomp \
        --use_x_mark_enc $use_x_mark_enc \
    > log_05292020_40/PEMS03/'0'_$model_name'_'weather'_'$seq_len'_'$pred_len'_'0.01.log 2>&1
  done
...
for pred_len in 12 24 48 96 ; do
   python -u  /mnt/nfs/data/home/1120231440/home/fuy/python/MICN_Experience/run.py \
        ...
        --front_use_decomp $front_use_decomp \
        --use_x_mark_enc $use_x_mark_enc \
    > log_05292020_40/PEMS04/'0'_$model_name'_'weather'_'$seq_len'_'$pred_len'_'0.01.log 2>&1
  done
#PEMS07
for pred_len in 12 24 48 96 ; do
   python -u  /mnt/nfs/data/home/1120231440/home/fuy/python/MICN_Experience/run.py \
        ...
        --front_use_decomp $front_use_decomp \
        --use_x_mark_enc $use_x_mark_enc \
    > log_05292020_40/PEMS07/'0'_$model_name'_'weather'_'$seq_len'_'$pred_len'_'0.01.log 2>&1
  done
#PEMS08
for pred_len in 12 24 48 96 ; do
   python -u  /mnt/nfs/data/home/1120231440/home/fuy/python/MICN_Experience/run.py \
        ...
        --front_use_decomp $front_use_decomp \
        --use_x_mark_enc $use_x_mark_enc \
    > log_05292020_40/PEMS08/'0'_$model_name'_'weather'_'$seq_len'_'$pred_len'_'0.01.log 2>&1
  done

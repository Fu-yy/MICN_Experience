...
seq_len=96
if [ ! -d "./log_05011444_40" ]; then
    mkdir ./log_05011444_40
fi

if [ ! -d "./log_05011444_40/ETTm1" ]; then
    mkdir ./log_05011444_40/ETTm1
fi
if [ ! -d "./log_05011444_40/ETTh1" ]; then
    mkdir ./log_05011444_40/ETTh1
fi
if [ ! -d "./log_05011444_40/ETTm2" ]; then
    mkdir ./log_05011444_40/ETTm2
fi

if [ ! -d "./log_05011444_40/ETTh2" ]; then
    mkdir ./log_05011444_40/ETTh2
fi
if [ ! -d "./log_05011444_40/electricity" ]; then
    mkdir ./log_05011444_40/electricity
fi
...
# m2 d_model= d_ff = 128
  for pred_len in 96 192 336 720; do
   python -u  /mnt/nfs/data/home/1120231440/home/fuy/python/MICN_Experience/run.py \
    ...
    > log_05011444_40/ETTm2/'0'_$model_name'_'ETTm2'_'$seq_len'_'$pred_len'_'0.01.log 2>&1
  done
...
# m1 d_model= d_ff = 128
  ...
  for pred_len in 96 192 336 720; do
   python -u  /mnt/nfs/data/home/1120231440/home/fuy/python/MICN_Experience/run.py \
        ...
        --down_sampling_window 2 \
        --channel_independence 1 \
    > log_05011444_40/ETTm1/'0'_$model_name'_'ETTm1'_'$seq_len'_'$pred_len'_'0.01.log 2>&1
  done
...
for pred_len in 96  192 336 720; do
 python -u  /mnt/nfs/data/home/1120231440/home/fuy/python/MICN_Experience/run.py \
      ...
      --down_sampling_window 2 \
      --channel_independence 1 \
  > log_05011444_40/ETTh1/'0'_$model_name'_'ETTh1'_'$seq_len'_'$pred_len'_'0.01.log 2>&1
done
...
for pred_len in 96  192 336 720; do
   python -u  /mnt/nfs/data/home/1120231440/home/fuy/python/MICN_Experience/run.py \
        ...
        --down_sampling_window 2 \
        --channel_independence 1 \
    > log_05011444_40/ETTh2/'0'_$model_name'_'ETTh2'_'$seq_len'_'$pred_len'_'0.01.log 2>&1
  done
...
# electricity d_model=d_ff=512
 ...
 for pred_len in 96 192 336 720 ; do
   python -u  /mnt/nfs/data/home/1120231440/home/fuy/python/MICN_Experience/run.py \
        ...
        --use_space_merge $use_space_merge \
        --use_fourier $use_fourier \
    > log_05011444_40/electricity/'0'_$model_name'_'electricity'_'$seq_len'_'$pred_len'_'0.01.log 2>&1
  done

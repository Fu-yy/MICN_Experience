...
seq_len=96
if [ ! -d "./log_04101542_40" ]; then
    mkdir ./log_04101542_40
fi

if [ ! -d "./log_04101542_40/ETTm1" ]; then
    mkdir ./log_04101542_40/ETTm1
fi
if [ ! -d "./log_04101542_40/ETTh1" ]; then
    mkdir ./log_04101542_40/ETTh1
fi
if [ ! -d "./log_04101542_40/ETTm2" ]; then
    mkdir ./log_04101542_40/ETTm2
fi

if [ ! -d "./log_04101542_40/ETTh2" ]; then
    mkdir ./log_04101542_40/ETTh2
fi
...
decomp_kernel=(17 49 81)
  for pred_len in 96 192 336 720; do
   python -u  /mnt/nfs/data/home/1120231440/home/fuy/python/MICN_Experience/run.py \
    ...
    > log_04101542_40/ETTm2/'0'_$model_name'_'ETTm2'_'$seq_len'_'$pred_len'_'0.01.log 2>&1
  done
...
m1_batch_size=16
  for pred_len in 96 192 336 720; do
   python -u  /mnt/nfs/data/home/1120231440/home/fuy/python/MICN_Experience/run.py \
        ...
        --down_sampling_window 2 \
        --channel_independence 1 \
    > log_04101542_40/ETTm1/'0'_$model_name'_'ETTm1'_'$seq_len'_'$pred_len'_'0.01.log 2>&1
  done
...
for pred_len in 96  192 336 720; do
 python -u  /mnt/nfs/data/home/1120231440/home/fuy/python/MICN_Experience/run.py \
      ...
      --down_sampling_window 2 \
      --channel_independence 1 \
  > log_04101542_40/ETTh1/'0'_$model_name'_'ETTh1'_'$seq_len'_'$pred_len'_'0.01.log 2>&1
done
#  h2 2分解核
...
for pred_len in 96  192 336 720; do
   python -u  /mnt/nfs/data/home/1120231440/home/fuy/python/MICN_Experience/run.py \
        ...
        --down_sampling_window 2 \
        --channel_independence 1 \
    > log_04101542_40/ETTh2/'0'_$model_name'_'ETTh2'_'$seq_len'_'$pred_len'_'0.01.log 2>&1
  done

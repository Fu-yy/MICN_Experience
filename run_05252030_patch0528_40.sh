...
# 新      v202405252030      测试exchange为何维度对不上          2024.5.28 20：50
...
# Exchange d_model=d_ff=128
  for pred_len in 96 192 336 720; do
   python -u  /mnt/nfs/data/home/1120231440/home/fuy/python/MICN_Experience/run.py \
        ...
        --season_use_fourier $season_use_fourier \
        --trend_use_conv $trend_use_conv \
    > log_05252030_40/Exchange/'x_mark_len_3_0'_$model_name'_'Exchange'_'$seq_len'_'$pred_len'_'0.01.log 2>&1
  done
  ...
  for pred_len in 96 192 336 720; do
   python -u  /mnt/nfs/data/home/1120231440/home/fuy/python/MICN_Experience/run.py \
        ...
        --season_use_fourier $season_use_fourier \
        --trend_use_conv $trend_use_conv \
    > log_05252030_40/Exchange/'x_mark_len_4_0'_$model_name'_'Exchange'_'$seq_len'_'$pred_len'_'0.01.log 2>&1
  done
  ...
  for pred_len in 96 192 336 720; do
   python -u  /mnt/nfs/data/home/1120231440/home/fuy/python/MICN_Experience/run.py \
        ...
        --season_use_fourier $season_use_fourier \
        --trend_use_conv $trend_use_conv \
    > log_05252030_40/Exchange/'x_mark_len_5_0'_$model_name'_'Exchange'_'$seq_len'_'$pred_len'_'0.01.log 2>&1
  done
...
seq_len=96
if [ ! -d "./log_05132001_40_windows" ]; then
    mkdir ./log_05132001_40_windows
fi

if [ ! -d "./log_05132001_40_windows/ETTm1" ]; then
    mkdir ./log_05132001_40_windows/ETTm1
fi
if [ ! -d "./log_05132001_40_windows/ETTh1" ]; then
    mkdir ./log_05132001_40_windows/ETTh1
fi
if [ ! -d "./log_05132001_40_windows/ETTm2" ]; then
    mkdir ./log_05132001_40_windows/ETTm2
fi

if [ ! -d "./log_05132001_40_windows/ETTh2" ]; then
    mkdir ./log_05132001_40_windows/ETTh2
fi
if [ ! -d "./log_05132001_40_windows/electricity" ]; then
    mkdir ./log_05132001_40_windows/electricity
fi

if [ ! -d "./log_05132001_40_windows/Exchange" ]; then
    mkdir ./log_05132001_40_windows/Exchange
fi

if [ ! -d "./log_05132001_40_windows/illness" ]; then
    mkdir ./log_05132001_40_windows/illness
fi

if [ ! -d "./log_05132001_40_windows/weather" ]; then
    mkdir ./log_05132001_40_windows/weather
fi

if [ ! -d "./log_05132001_40_windows/Traffic" ]; then
    mkdir ./log_05132001_40_windows/Traffic
fi
...
# m2 d_model= d_ff = 128
  for pred_len in 96 192 336 720; do
   python -u  run.py \
    ...
    > log_05132001_40_windows/ETTm2/'0'_$model_name'_'ETTm2'_'$seq_len'_'$pred_len'_'0.01.log 2>&1
  done
...
# m1 d_model= d_ff = 128
  ...
  for pred_len in 96 192 336 720; do
   python -u  run.py \
        ...
        --season_use_fourier $season_use_fourier \
        --trend_use_conv $trend_use_conv \
    > log_05132001_40_windows/ETTm1/'0'_$model_name'_'ETTm1'_'$seq_len'_'$pred_len'_'0.01.log 2>&1
  done
...
for pred_len in 96  192 336 720; do
 python -u  run.py \
      ...
      --season_use_fourier $season_use_fourier \
      --trend_use_conv $trend_use_conv \
  > log_05132001_40_windows/ETTh1/'0'_$model_name'_'ETTh1'_'$seq_len'_'$pred_len'_'0.01.log 2>&1
done
...
for pred_len in 96  192 336 720; do
   python -u  run.py \
        ...
        --season_use_fourier $season_use_fourier \
        --trend_use_conv $trend_use_conv \
    > log_05132001_40_windows/ETTh2/'0'_$model_name'_'ETTh2'_'$seq_len'_'$pred_len'_'0.01.log 2>&1
  done
...
# electricity d_model=d_ff=512
 ...
 for pred_len in 96 192 336 720 ; do
   python -u  run.py \
        ...
        --season_use_fourier $season_use_fourier \
        --trend_use_conv $trend_use_conv \
    > log_05132001_40_windows/electricity/'0'_$model_name'_'electricity'_'$seq_len'_'$pred_len'_'0.01.log 2>&1
  done
...
for pred_len in 96 192 336 720; do
   python -u  run.py \
        ...
        --season_use_fourier $season_use_fourier \
        --trend_use_conv $trend_use_conv \
    > log_05132001_40_windows/Traffic/'0'_$model_name'_'Traffic'_'$seq_len'_'$pred_len'_'0.01.log 2>&1
  done
...
# Exchange d_model=d_ff=128
  for pred_len in 96 192 336 720; do
   python -u  run.py \
        ...
        --season_use_fourier $season_use_fourier \
        --trend_use_conv $trend_use_conv \
    > log_05132001_40_windows/Exchange/'0'_$model_name'_'Exchange'_'$seq_len'_'$pred_len'_'0.01.log 2>&1
  done
...
# weather d_ff=d_ff=512
  for pred_len in 96 192 336 720 ; do
   python -u  run.py \
        ...
        --season_use_fourier $season_use_fourier \
        --trend_use_conv $trend_use_conv \
    > log_05132001_40_windows/weather/'0'_$model_name'_'weather'_'$seq_len'_'$pred_len'_'0.01.log 2>&1
  done

...
seq_len=96
if [ ! -d "./log_05242107_40" ]; then
    mkdir ./log_05242107_40
fi

if [ ! -d "./log_05242107_40/ETTm1" ]; then
    mkdir ./log_05242107_40/ETTm1
fi
if [ ! -d "./log_05242107_40/ETTh1" ]; then
    mkdir ./log_05242107_40/ETTh1
fi
if [ ! -d "./log_05242107_40/ETTm2" ]; then
    mkdir ./log_05242107_40/ETTm2
fi

if [ ! -d "./log_05242107_40/ETTh2" ]; then
    mkdir ./log_05242107_40/ETTh2
fi
if [ ! -d "./log_05242107_40/electricity" ]; then
    mkdir ./log_05242107_40/electricity
fi

if [ ! -d "./log_05242107_40/Exchange" ]; then
    mkdir ./log_05242107_40/Exchange
fi

if [ ! -d "./log_05242107_40/illness" ]; then
    mkdir ./log_05242107_40/illness
fi

if [ ! -d "./log_05242107_40/weather" ]; then
    mkdir ./log_05242107_40/weather
fi

if [ ! -d "./log_05242107_40/Traffic" ]; then
    mkdir ./log_05242107_40/Traffic
fi
...
# m2 d_model= d_ff = 128
  for pred_len in 96 192 336 720; do
   python -u  /mnt/nfs/data/home/1120231440/home/fuy/python/MICN_Experience/run.py \
    ...
    > log_05242107_40/ETTm2/'0'_$model_name'_'ETTm2'_'$seq_len'_'$pred_len'_'0.01.log 2>&1
  done
...
# m1 d_model= d_ff = 128
  ...
  for pred_len in 96 192 336 720; do
   python -u  /mnt/nfs/data/home/1120231440/home/fuy/python/MICN_Experience/run.py \
    ...
    > log_05242107_40/ETTm1/'0'_$model_name'_'ETTm1'_'$seq_len'_'$pred_len'_'0.01.log 2>&1
  done
...
for pred_len in 96  192 336 720; do
 python -u  /mnt/nfs/data/home/1120231440/home/fuy/python/MICN_Experience/run.py \
      ...
      --trend_use_conv $trend_use_conv \
  > log_05242107_40/ETTh1/'0'_$model_name'_'ETTh1'_'$seq_len'_'$pred_len'_'0.01.log 2>&1
done
...
for pred_len in 96  192 336 720; do
   python -u  /mnt/nfs/data/home/1120231440/home/fuy/python/MICN_Experience/run.py \
        ...
        --cut_freq $ETTh1_cut_freq \
        --trend_use_conv $trend_use_conv \
    > log_05242107_40/ETTh2/'0'_$model_name'_'ETTh2'_'$seq_len'_'$pred_len'_'0.01.log 2>&1
  done
...
# electricity d_model=d_ff=512
 ...
 for pred_len in 96 192 336 720 ; do
   python -u  /mnt/nfs/data/home/1120231440/home/fuy/python/MICN_Experience/run.py \
        ...
        --season_use_fourier $season_use_fourier \
        --trend_use_conv $trend_use_conv \
    > log_05242107_40/electricity/'0'_$model_name'_'electricity'_'$seq_len'_'$pred_len'_'0.01.log 2>&1
  done
...
for pred_len in 96 192 336 720; do
   python -u  /mnt/nfs/data/home/1120231440/home/fuy/python/MICN_Experience/run.py \
        ...
        --season_use_fourier $season_use_fourier \
        --trend_use_conv $trend_use_conv \
    > log_05242107_40/Traffic/'0'_$model_name'_'Traffic'_'$seq_len'_'$pred_len'_'0.01.log 2>&1
  done
...
# Exchange d_model=d_ff=128
  for pred_len in 96 192 336 720; do
   python -u  /mnt/nfs/data/home/1120231440/home/fuy/python/MICN_Experience/run.py \
        ...
        --season_use_fourier $season_use_fourier \
        --trend_use_conv $trend_use_conv \
    > log_05242107_40/Exchange/'0'_$model_name'_'Exchange'_'$seq_len'_'$pred_len'_'0.01.log 2>&1
  done
...
# weather d_ff=d_ff=512
  for pred_len in 96 192 336 720 ; do
   python -u  /mnt/nfs/data/home/1120231440/home/fuy/python/MICN_Experience/run.py \
        ...
        --season_use_fourier $season_use_fourier \
        --trend_use_conv $trend_use_conv \
    > log_05242107_40/weather/'0'_$model_name'_'weather'_'$seq_len'_'$pred_len'_'0.01.log 2>&1
  done
